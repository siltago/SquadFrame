  ...
  const [{ data: obras }, { data: solAprovadas }, { data: lotesAtivos }, tipos, fornecedores, formas, coresRalBase] =
    await Promise.all([
      ...
      admin.from("solicitacoes_compra")
        .select("id, numero, fornecedor_id, tipo_linha, obra:obras(id, nome), itens:solicitacao_itens(id, quantidade, unidade, observacoes, descricao_manual, cor_id, largura_m, altura_m, qtd_pecas, produto:produtos(id, codigo_mestre, nome, unidade))")
        .eq("status", "APROVADA"),
