...
import { criarProduto } from "@/modules/squadstock/actions/catalogo/actions";
...
export default async function NovoProdutoPage({
  ...
  return (
    <div className="px-8 py-8">
      <BackButton href={`/squadstock/catalogo/${params.linhaId}`} />
      ...
      <ServerActionForm action={criarProdutoNaLinha} className="card mt-6 max-w-2xl p-6">
        ...
        <div className="mt-6 flex gap-3">
          ...
          <Button as="a" href={`/squadstock/catalogo/${params.linhaId}`} variant="ghost">
            Cancelar
          </Button>
        </div>
      </ServerActionForm>
