    ...
    <div className="min-h-screen bg-bg">
      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-8 sm:px-10">
        <div className="mb-6 flex items-center gap-3">
          <h1 className="text-3xl font-bold tracking-tight text-text sm:text-4xl">SquadFlow</h1>
          <Badge variant="default" size="sm">Em breve</Badge>
        </div>
        <p className="text-base text-text-2">
          Gerenciador de fábrica, produção e chão de fábrica.
        </p>
      </main>
    </div>
  );
